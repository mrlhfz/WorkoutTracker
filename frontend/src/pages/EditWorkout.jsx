  ...
  return (
    <div>
      <div style={{ marginBottom: 20 }}>
        <Link to="/history" style={{ color: 'var(--sub)', fontSize: 13 }}>← Back to History</Link>
      </div>
      <h1 className="page-title">EDIT WORKOUT</h1>
      <div className="card">
        <WorkoutForm initial={workout} onSubmit={handleSubmit} submitLabel="Update Workout" loading={loading} />
      </div>
    </div>
  )
}
